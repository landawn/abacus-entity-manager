 ...
 * @version ${version}
 */
public class AutoGeneratedClass extends AbstractDirtyMarker {
    ...
    public AutoGeneratedClass() {
        super(AutoGeneratedClass.class.getSimpleName());
    }

    public AutoGeneratedClass(Date field3, List<Calendar> field4, Date field5, Optional<Timestamp> field6, Range<Time> field7, Time field8, Map<List<Stream<String>>, String> field9, List<Map<String, List<Map<Float, Double>>>> field10) {
        super(AutoGeneratedClass.class.getSimpleName());
    ...
    public AutoGeneratedClass setField3(Date field3) {
        super.setUpdatedPropName("field3");
        this.field3 = field3;
    ...
    public AutoGeneratedClass setField4(List<Calendar> field4) {
        super.setUpdatedPropName("field4");
        this.field4 = field4;
    ...
    public AutoGeneratedClass setField5(Date field5) {
        super.setUpdatedPropName("field5");
        this.field5 = field5;
    ...
    public AutoGeneratedClass setField6(Optional<Timestamp> field6) {
        super.setUpdatedPropName("field6");
        this.field6 = field6;
    ...
    public AutoGeneratedClass setField7(Range<Time> field7) {
        super.setUpdatedPropName("field7");
        this.field7 = field7;
    ...
    public AutoGeneratedClass setField8(Time field8) {
        super.setUpdatedPropName("field8");
        this.field8 = field8;
    ...
    public AutoGeneratedClass setField9(Map<List<Stream<String>>, String> field9) {
        super.setUpdatedPropName("field9");
        this.field9 = field9;
    ...
    public AutoGeneratedClass setField10(List<Map<String, List<Map<Float, Double>>>> field10) {
        super.setUpdatedPropName("field10");
        this.field10 = field10;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AutoGeneratedClass) {
            final AutoGeneratedClass other = (AutoGeneratedClass) obj;

            return N.equals(field3, other.field3)
                && N.equals(field4, other.field4)
                && N.equals(field5, other.field5)
                && N.equals(field6, other.field6)
                && N.equals(field7, other.field7)
                && N.equals(field8, other.field8)
                && N.equals(field9, other.field9)
                && N.equals(field10, other.field10);
        }
    ...
    public String toString() {
        return "{field3=" + N.toString(field3)
                 + ", field4=" + N.toString(field4)
                 + ", field5=" + N.toString(field5)
                 + ", field6=" + N.toString(field6)
                 + ", field7=" + N.toString(field7)
                 + ", field8=" + N.toString(field8)
                 + ", field9=" + N.toString(field9)
                 + ", field10=" + N.toString(field10)
                 + "}";
    }
}

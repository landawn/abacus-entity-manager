...
public class AccountDevice implements HbasePNL.AccountDevicePNL {
    ...
    public AccountDevice(HBaseColumn<Long> accountId, HBaseColumn<String> name, 
        HBaseColumn<String> udid, HBaseColumn<String> platform, 
        HBaseColumn<String> model, HBaseColumn<String> manufacturer, 
        HBaseColumn<Timestamp> produceTime, HBaseColumn<String> category, 
        HBaseColumn<String> description, HBaseColumn<Integer> status, 
        HBaseColumn<Timestamp> lastUpdateTime, HBaseColumn<Timestamp> createTime) {
        this();
    ...
    public AccountDevice(HBaseColumn<Long> id, HBaseColumn<Long> accountId, 
        HBaseColumn<String> name, HBaseColumn<String> udid, 
        HBaseColumn<String> platform, HBaseColumn<String> model, 
        HBaseColumn<String> manufacturer, HBaseColumn<Timestamp> produceTime, 
        HBaseColumn<String> category, HBaseColumn<String> description, 
        HBaseColumn<Integer> status, HBaseColumn<Timestamp> lastUpdateTime, 
        HBaseColumn<Timestamp> createTime) {
        this();

...
public class Account implements HbasePNL.AccountPNL {
    ...
    public Account(Map<Long, HBaseColumn<String>> gui, SortedMap<Long, HBaseColumn<String>> emailAddress, Name name, HBaseColumn<Integer> status,
            LinkedHashMap<Long, HBaseColumn<Timestamp>> lastUpdateTime, Map<Long, HBaseColumn<Timestamp>> createTime, AccountContact contact,
    ...
    public HBaseColumn<String> gui() {
        return (HBaseColumn<String>) (N.isNullOrEmpty(gui) ? HBaseColumn.emptyOf(String.class) : gui.values().iterator().next());
    }
    ...
    public HBaseColumn<String> emailAddress() {
        return (HBaseColumn<String>) (N.isNullOrEmpty(emailAddress) ? HBaseColumn.emptyOf(String.class) : emailAddress.values().iterator().next());
    }
    ...
    public Account setEmailAddress(HBaseColumn<String> hbaseColumn) {
        if (emailAddress == null) {
            emailAddress = new java.util.TreeMap<Long, HBaseColumn<String>>(HBaseColumn.DESC_HBASE_VERSION_COMPARATOR);
        } else {
            emailAddress.clear();
        }
    ...
    public HBaseColumn<Timestamp> lastUpdateTime() {
        return (HBaseColumn<Timestamp>) (N.isNullOrEmpty(lastUpdateTime) ? HBaseColumn.emptyOf(Timestamp.class) : lastUpdateTime.values().iterator().next());
    }
    ...
    public Map<Long, HBaseColumn<Timestamp>> getCreateTime() {
        return createTime;
    }

    public Account setCreateTime(Map<Long, HBaseColumn<Timestamp>> createTime) {
    ...
    public HBaseColumn<Timestamp> createTime() {
        return (HBaseColumn<Timestamp>) (N.isNullOrEmpty(createTime) ? HBaseColumn.emptyOf(Timestamp.class) : createTime.values().iterator().next());
    }

    public Account setCreateTime(Timestamp value) {
        setCreateTime(HBaseColumn.valueOf(value));

        return this;
    }

    public Account setCreateTime(Timestamp value, long version) {
        setCreateTime(HBaseColumn.valueOf(value, version));

        return this;
    }

    public Account setCreateTime(HBaseColumn<Timestamp> hbaseColumn) {
        if (createTime == null) {
            createTime = N.newInstance(java.util.Map.class);
        } else {
            createTime.clear();
        }

        createTime.put(hbaseColumn.version(), hbaseColumn);

        return this;
    }

    public Account addCreateTime(Timestamp value) {
        addCreateTime(HBaseColumn.valueOf(value));

        return this;
    }

    public Account addCreateTime(Timestamp value, long version) {
        addCreateTime(HBaseColumn.valueOf(value, version));

        return this;
    }

    public Account addCreateTime(HBaseColumn<Timestamp> hbaseColumn) {
        if (createTime == null) {
            createTime = N.newInstance(java.util.Map.class);
        }
    ...
    public int hashCode() {
        ...
        h = 31 * h + Objects.hashCode(strMap);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Account) {
            ...
            return Objects.equals(id, other.id) && Objects.equals(gui, other.gui) && Objects.equals(emailAddress, other.emailAddress)
                    ...
                    && Objects.equals(createTime, other.createTime) && Objects.equals(contact, other.contact) && Objects.equals(strSet, other.strSet)
    ...
    public String toString() {
        return "{id=" + Objects.toString(id) + ", gui=" + Objects.toString(gui) + ", emailAddress=" + Objects.toString(emailAddress) + ", name="
                + Objects.toString(name) + ", status=" + Objects.toString(status) + ", lastUpdateTime=" + Objects.toString(lastUpdateTime) + ", createTime="
                + Objects.toString(createTime) + ", contact=" + Objects.toString(contact) + ", strSet=" + Objects.toString(strSet) + ", strMap="

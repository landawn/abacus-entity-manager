...
public class Account implements HbasePNL.AccountPNL {
    ...
    public Account(Map<Long, HBaseColumn<String>> gui, 
        SortedMap<Long, HBaseColumn<String>> emailAddress, Name name, 
        HBaseColumn<Integer> status, 
        LinkedHashMap<Long, HBaseColumn<Timestamp>> lastUpdateTime, 
        Map<Long, HBaseColumn<Timestamp>> createTime, AccountContact contact, 
    ...
    public Account(long id, Map<Long, HBaseColumn<String>> gui, 
        SortedMap<Long, HBaseColumn<String>> emailAddress, Name name, 
        HBaseColumn<Integer> status, 
        LinkedHashMap<Long, HBaseColumn<Timestamp>> lastUpdateTime, 
        Map<Long, HBaseColumn<Timestamp>> createTime, AccountContact contact, 
    ...
    public String toString() {
         return "{id=" + Objects.toString(id)
                 ...
                 + ", strMap=" + Objects.toString(strMap)
                 + "}";
    }
}

...
public class DataType implements ImplDirtyBasicPNL.DataTypePNL, DirtyMarker {
    ...
    public DataType(byte byteType, char charType, boolean booleanType, short shortType, 
        int intType, long longType, float floatType, double doubleType, 
        BigInteger bigIntegerType, BigDecimal bigDecimalType, 
        String stringType, byte[] byteArrayType, Reader characterStreamType, 
        InputStream binaryStreamType, Clob clobType, Blob blobType, 
        Date dateType, Time timeType, Timestamp timestampType, 
        long longDateType, long longTimeType, long longTimestampType, 
        com.landawn.abacus.types.WeekDay enumType, 
        ArrayList<String> stringArrayListType, 
        LinkedList<Boolean> booleanLinkedListType, List<Double> doubleListType, 
        ArrayList<Date> dateArrayListType, 
        ArrayList<Timestamp> timestampArrayListType, 
        ArrayList<BigDecimal> bigDecimalArrayListType, 
        HashSet<String> stringHashSetType, 
        LinkedHashSet<Boolean> booleanLinkedHashSetType, 
        HashSet<Date> dateHashSetType, HashSet<Timestamp> timestampHashSetType, 
        HashSet<BigDecimal> bigDecimalHashSetType, 
        HashMap<String, String> stringHashMapType, 
        LinkedHashMap<String, Boolean> booleanLinkedHashMapType, 
        HashMap<String, Float> floatHashMapType, 
        HashMap<String, Date> dateHashMapType, 
        HashMap<Timestamp, Float> timestampHashMapType, 
        HashMap<BigDecimal, String> bigDecimalHashMapType, 
        Vector<String> stringVectorType, 
        ConcurrentHashMap<BigDecimal, String> stringConcurrentHashMapType, 
        com.landawn.abacus.entity.extendDirty.lvc.Account jsonType, 
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DataType) {
            ...
            return Objects.equals(byteType, other.byteType)
                && Objects.equals(charType, other.charType)
                && Objects.equals(booleanType, other.booleanType)
                && Objects.equals(shortType, other.shortType)
                && Objects.equals(intType, other.intType)
                && Objects.equals(longType, other.longType)
                && Objects.equals(floatType, other.floatType)
                && Objects.equals(doubleType, other.doubleType)
                && Objects.equals(bigIntegerType, other.bigIntegerType)
                && Objects.equals(bigDecimalType, other.bigDecimalType)
                && Objects.equals(stringType, other.stringType)
                && Objects.equals(byteArrayType, other.byteArrayType)
                && Objects.equals(characterStreamType, other.characterStreamType)
                && Objects.equals(binaryStreamType, other.binaryStreamType)
                && Objects.equals(clobType, other.clobType)
                && Objects.equals(blobType, other.blobType)
                && Objects.equals(dateType, other.dateType)
                && Objects.equals(timeType, other.timeType)
                && Objects.equals(timestampType, other.timestampType)
                && Objects.equals(longDateType, other.longDateType)
                && Objects.equals(longTimeType, other.longTimeType)
                && Objects.equals(longTimestampType, other.longTimestampType)
                && Objects.equals(enumType, other.enumType)
                && Objects.equals(stringArrayListType, other.stringArrayListType)
                && Objects.equals(booleanLinkedListType, other.booleanLinkedListType)
                && Objects.equals(doubleListType, other.doubleListType)
                && Objects.equals(dateArrayListType, other.dateArrayListType)
                && Objects.equals(timestampArrayListType, other.timestampArrayListType)
                && Objects.equals(bigDecimalArrayListType, other.bigDecimalArrayListType)
                && Objects.equals(stringHashSetType, other.stringHashSetType)
                && Objects.equals(booleanLinkedHashSetType, other.booleanLinkedHashSetType)
                && Objects.equals(dateHashSetType, other.dateHashSetType)
                && Objects.equals(timestampHashSetType, other.timestampHashSetType)
                && Objects.equals(bigDecimalHashSetType, other.bigDecimalHashSetType)
                && Objects.equals(stringHashMapType, other.stringHashMapType)
                && Objects.equals(booleanLinkedHashMapType, other.booleanLinkedHashMapType)
                && Objects.equals(floatHashMapType, other.floatHashMapType)
                && Objects.equals(dateHashMapType, other.dateHashMapType)
                && Objects.equals(timestampHashMapType, other.timestampHashMapType)
                && Objects.equals(bigDecimalHashMapType, other.bigDecimalHashMapType)
                && Objects.equals(stringVectorType, other.stringVectorType)
                && Objects.equals(stringConcurrentHashMapType, other.stringConcurrentHashMapType)
                && Objects.equals(jsonType, other.jsonType)
    ...
    public String toString() {
         return "{byteType=" + Objects.toString(byteType)
                 + ", charType=" + Objects.toString(charType)
                 + ", booleanType=" + Objects.toString(booleanType)
                 + ", shortType=" + Objects.toString(shortType)
                 + ", intType=" + Objects.toString(intType)
                 + ", longType=" + Objects.toString(longType)
                 + ", floatType=" + Objects.toString(floatType)
                 + ", doubleType=" + Objects.toString(doubleType)
                 + ", bigIntegerType=" + Objects.toString(bigIntegerType)
                 + ", bigDecimalType=" + Objects.toString(bigDecimalType)
                 + ", stringType=" + Objects.toString(stringType)
                 + ", byteArrayType=" + Objects.toString(byteArrayType)
                 + ", characterStreamType=" + Objects.toString(characterStreamType)
                 + ", binaryStreamType=" + Objects.toString(binaryStreamType)
                 + ", clobType=" + Objects.toString(clobType)
                 + ", blobType=" + Objects.toString(blobType)
                 + ", dateType=" + Objects.toString(dateType)
                 + ", timeType=" + Objects.toString(timeType)
                 + ", timestampType=" + Objects.toString(timestampType)
                 + ", longDateType=" + Objects.toString(longDateType)
                 + ", longTimeType=" + Objects.toString(longTimeType)
                 + ", longTimestampType=" + Objects.toString(longTimestampType)
                 + ", enumType=" + Objects.toString(enumType)
                 + ", stringArrayListType=" + Objects.toString(stringArrayListType)
                 + ", booleanLinkedListType=" + Objects.toString(booleanLinkedListType)
                 + ", doubleListType=" + Objects.toString(doubleListType)
                 + ", dateArrayListType=" + Objects.toString(dateArrayListType)
                 + ", timestampArrayListType=" + Objects.toString(timestampArrayListType)
                 + ", bigDecimalArrayListType=" + Objects.toString(bigDecimalArrayListType)
                 + ", stringHashSetType=" + Objects.toString(stringHashSetType)
                 + ", booleanLinkedHashSetType=" + Objects.toString(booleanLinkedHashSetType)
                 + ", dateHashSetType=" + Objects.toString(dateHashSetType)
                 + ", timestampHashSetType=" + Objects.toString(timestampHashSetType)
                 + ", bigDecimalHashSetType=" + Objects.toString(bigDecimalHashSetType)
                 + ", stringHashMapType=" + Objects.toString(stringHashMapType)
                 + ", booleanLinkedHashMapType=" + Objects.toString(booleanLinkedHashMapType)
                 + ", floatHashMapType=" + Objects.toString(floatHashMapType)
                 + ", dateHashMapType=" + Objects.toString(dateHashMapType)
                 + ", timestampHashMapType=" + Objects.toString(timestampHashMapType)
                 + ", bigDecimalHashMapType=" + Objects.toString(bigDecimalHashMapType)
                 + ", stringVectorType=" + Objects.toString(stringVectorType)
                 + ", stringConcurrentHashMapType=" + Objects.toString(stringConcurrentHashMapType)
                 + ", jsonType=" + Objects.toString(jsonType)
                 + ", xmlType=" + Objects.toString(xmlType)
                 + "}";
    }
}

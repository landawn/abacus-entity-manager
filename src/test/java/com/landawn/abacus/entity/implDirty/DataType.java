 ...
 * @version ${version}
 */
public class DataType implements ImplDirtyPNL.DataTypePNL, DirtyMarker {
    ...
    public DataType(byte byteType, char charType, boolean booleanType, short shortType, 
        ...
        String enumType, ArrayList<String> stringArrayListType, 
        ...
        String jsonType, String xmlType) {
        this();

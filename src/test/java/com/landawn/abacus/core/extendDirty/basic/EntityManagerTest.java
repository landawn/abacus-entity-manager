...
import com.landawn.abacus.entity.extendDirty.basic.AclUserGroupRelationship;
...
public class EntityManagerTest extends AbstractEntityManager1Test {
    ...
    public void test_lock() {
        ...
        try {
            em.lockRecord(entityId, LockMode.D, null);
            fail("Should throw UnsupportedOperationException");
        } catch (UnsupportedOperationException e) {
        }

        try {
            em.unlockRecord(entityId, null, null);
            fail("Should throw UnsupportedOperationException");
        } catch (UnsupportedOperationException e) {
        }
    }
    ...
    @Test
    public void testCRUD_n() throws Exception {
        long startTime = System.currentTimeMillis();
        final AtomicInteger activeThreadNum = new AtomicInteger();

        for (int i = 0; i < 10; i++) {
            final List<Account> accountList = createAccountList(Account.class, 200);
        ...
        List<Account> accountList2 = em.list(Account.__, null, null);
    ...
    public void testCRUD4() {
        ...
        String columnNameWithAlias = "id AS abc123";
        dataSet = em.query(Account.__, N.asList("id AS abc123"), CF.eq(Account.ID, account.getId()), null, N.asProps(Options.Query.COMBINE_PROPERTIES, true));
        dataSet.println();
        assertTrue(dataSet.containsColumn(columnNameWithAlias));
    ...
    public void testBatchAdd() {
        this.addAccount(Account.class, 799);
    }
    ...
    public void test_batch() {
        List<Account> accounts = this.addAccount(Account.class, 1333);
